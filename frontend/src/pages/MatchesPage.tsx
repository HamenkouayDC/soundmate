          ...
          <div className="grid gap-8 lg:grid-cols-[360px_1fr]">
            <aside className="rounded-[34px] border border-white/60 bg-white/70 p-8 shadow-[0_25px_80px_rgba(80,0,120,0.14)] backdrop-blur-xl">
              ...
              <p className="mt-4 text-sm leading-7 text-gray-600">
                ...
                Чаты пока не подключены, поэтому кнопка временно неактивна.
              </p>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="rounded-3xl bg-[#08050d] p-5 text-white">
                  <p className="text-sm font-black">Чаты скоро</p>

                  <p className="mt-2 text-sm leading-6 text-white/70">
                    Следующим шагом можно добавить страницу `/chat/:id` на
                    mock-данных.
                  </p>
                </div>
              </div>
            ...
            <div className="grid gap-5">
              {mockMatches.map((match) => (
                <article
                  className="group rounded-[34px] border border-white/60 bg-white/75 p-5 shadow-[0_25px_80px_rgba(80,0,120,0.12)] backdrop-blur-xl transition hover:-translate-y-1 hover:shadow-[0_30px_90px_rgba(80,0,120,0.18)]"
                  key={match.id}
                >
                  <div className="grid gap-5 md:grid-cols-[140px_1fr_auto] md:items-center">
                    <div className="relative flex h-36 items-center justify-center overflow-hidden rounded-[28px] border border-[#d923ff]/60 bg-gradient-to-br from-[#120617] via-[#3b0b4d] to-[#d923ff]">
                    ...
                    <div className="flex md:justify-end">
                      <button
                        className="w-full rounded-2xl bg-[#100516] px-6 py-3 text-sm font-bold text-white transition group-hover:bg-[#d923ff] md:w-auto"
                        type="button"
                        disabled
                      >
                        Чат скоро
